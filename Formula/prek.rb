class Prek < Formula
  ...
  version "0.4.2"
  if OS.mac?
    url "https://github.com/j178/prek/releases/download/v0.4.2/prek-aarch64-apple-darwin.tar.gz" if Hardware::CPU.arm?
  ...
  if OS.linux?
    if Hardware::CPU.arm?
      url "https://github.com/j178/prek/releases/download/v0.4.2/prek-aarch64-unknown-linux-gnu.tar.gz"
    end
    if Hardware::CPU.intel?
      url "https://github.com/j178/prek/releases/download/v0.4.2/prek-x86_64-unknown-linux-gnu.tar.gz"
    end
  end
  license "MIT"
