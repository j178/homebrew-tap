class Prek < Formula
  ...
  if OS.mac?
    ...
    if Hardware::CPU.intel?
      url "https://github.com/j178/prek/releases/download/v0.4.11/prek-x86_64-apple-darwin.tar.gz"
    end
  end
  if OS.linux?
    if Hardware::CPU.arm?
      url "https://github.com/j178/prek/releases/download/v0.4.11/prek-aarch64-unknown-linux-gnu.tar.gz"
    end
    if Hardware::CPU.intel?
